// vendored from code-kit@0.6.0, src/ts/pure/model-choice.ts — do not hand-edit; re-vendor via tools/sync-kit.sh (Einzeldatei, s. VENDOR.json vendored_mixed_version)

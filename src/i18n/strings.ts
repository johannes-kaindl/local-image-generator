...
export const EN: Record<string, string> = {
  ...
  "status.outOfMemory": "Not enough memory for this model — try a smaller size or free up GPU memory.",
...
export const DE: Record<string, string> = {
  ...
  "status.outOfMemory": "Nicht genug Speicher für dieses Modell — kleinere Größe versuchen oder GPU-Speicher freigeben.",

...
export const EN: Record<string, string> = {
  ...
  "empty.notDownloaded": "The built-in model (SD-Turbo, ≈ 2.6 GB) is not downloaded yet. Nothing is downloaded before you click.",
...
export const DE: Record<string, string> = {
  ...
  "empty.notDownloaded": "Das eingebaute Modell (SD-Turbo, ≈ 2,6 GB) ist noch nicht heruntergeladen. Ohne Klick wird nichts geladen.",
